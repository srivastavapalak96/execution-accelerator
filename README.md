...
9. fixture-backed or live failure escalation summaries, including persisted escalation bundle paths in run output, code-diff summaries, validation context, and richer complex-plan context for tough-path failures
