...
9. fixture-backed or live failure escalation summaries, including persisted escalation bundle paths in run output, code-diff summaries, and richer complex-plan context for tough-path failures
...
12. CLI summaries that surface skipped repositories and raw skip reasons such as existing open remediation PRs, plus changed-file counts, aggregate diff totals, and primary change summaries
