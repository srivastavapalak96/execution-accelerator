...
8. fixture-backed delivery metadata on success, plus live branch publication / PR creation / Jira completion comments and optional done transitions; delivery-approved complex runs can now publish ready PRs instead of remaining draft-only, and GitHub PR-create conflicts can recover the existing open PR instead of failing delivery
