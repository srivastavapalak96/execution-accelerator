...
| Typed schemas and remediation state | SHIPPED | Core workflow models and state exist, and persisted remediation plans now carry more concrete complex-lane summary/rationale details. |
