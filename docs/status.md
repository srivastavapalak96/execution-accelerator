...
| Retry matrix | PARTIAL | Recoverable validation failures can now re-run the active remediation lane within a bounded retry budget before escalating; richer retry policies are still missing. |
