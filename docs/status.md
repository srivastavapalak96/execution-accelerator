...
| Delivery | PARTIAL | Live branch publication and PR creation now exist; Jira completion can post a comment and optionally fire a configured done transition, and delivery-approved complex runs can publish ready PRs instead of remaining draft-only, but richer workflow handling is still missing. |
